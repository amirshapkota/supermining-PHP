...
<head>
    ...
    <title>supermining - Crypto Payment <small>#a312-900-f3f1c</small></title>
                    ...
                    <ol class="breadcrumb justify-content-left mt-n2 mb-4" data-aos="zoom-in">
                        <li class="breadcrumb-item"><a href="#"><span class="text-color-dark"><i
                                            ...
                                            class="text-color-dark">Dashboard</span></a></li>
                                                                                                            <li class="active breadcrumb-item">Crypto Payment</li>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="user-funds-block">
                        <div>
                            ...
                            <span class="value">
                                <a href="transactions.php"><sup>$</sup><? echo $desposite ?></a>
                            </span>
    ...
    <div class="col-sm-12" align="center">
            ...
            <p>Payment times out in <span id="time"></span> minutes.</p>
                ...
                <tr>
                    ...
                    <td><code>M9nSmRCFn1kMSAp6w1h9BNtypL4xvnhax6</code></td>
                </tr>
                                <tr>
                    <td>Payment Amount</td>
                    <td><code>Amount</code> LTC</td>
                </tr>
            ...
            <script type="text/javascript">
                ...
                window.onload = function () {
                    var fiveMinutes = 60 * 59.566666666667,
