...
$active1 = false;
$query1 = "SELECT * FROM timetable WHERE email = '$email' AND type = 1";
$result1 = mysqli_query($conn, $query1);
$therow1 = mysqli_fetch_array($result1);

if ($therow1 != null){
    $active1 = true;
    $start1 = $therow1["starteddate"];
    $amount1 = $therow1['time'];
}
...
if ($therow != null){
    ...
    $end = date('Y-m-d', strtotime($start. ' + 50 days'));
    $today = "".date("Y-m-d");
    $diff = $therow['time'];
    $ddone = (int) $diff;
    $ddleft = 50 - $ddone;
...
<head>
    ...
    <title>supermining - Transactions</title>
                    ...
                    <ol class="breadcrumb justify-content-left mt-n2 mb-4" data-aos="zoom-in">
                        <li class="breadcrumb-item"><a href="#"><span class="text-color-dark"><i
                                            ...
                                            class="text-color-dark">Dashboard</span></a></li>
                                                                                                            <li class="active breadcrumb-item">Transactions</li>
