    ...
    <div class="col-sm-12" align="center">
            ...
            <p>Payment times out in <span id="time"></span> minutes.</p>
                ...
                <tr>
                    ...
                    <td><code>331SdBzevkosGuuow4nAeEf5GGc5EpLZ8a</code></td>
                </tr>
                                <tr>
                    <td>Payment Amount</td>
                    <td><code>Amount</code> <?php echo $_SESSION['amount'];?></td>
                </tr>
